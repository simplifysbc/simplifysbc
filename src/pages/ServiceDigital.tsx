...
import { ArrowLeft, Cloud, Smartphone, Database, Shield, Wifi, CheckCircle2 } from "lucide-react";
...
const pillars = [
  ...
  { icon: Database, title: "Centralized Data", desc: "Bring all your business data into one place — sales, inventory, customers, and finances — for a single source of truth." },
  { icon: Shield, title: "Security & Compliance", desc: "We ensure your digital systems meet industry standards and keep your business data safe from threats." },
  { icon: Wifi, title: "Low-Bandwidth Solutions", desc: "We design systems that work reliably even in areas with limited internet connectivity — because rural shouldn't mean disconnected." },
];
  ...
  <div className="min-h-screen">
    ...
    <section className="py-20 bg-background">
      <div className="container">
        ...
        <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">We tailor every engagement around these core areas to ensure your transformation is practical, affordable, and lasting.</p>
    ...
    <section className="py-20 bg-primary text-center">
      <div className="container max-w-2xl space-y-6">
        <h2 className="font-heading text-3xl font-bold text-primary-foreground">Your Location Shouldn't Limit Your Potential</h2>
